...
import { baseFormDefaults } from '@/config/forms/user/ArtPracticeWorksheet'
import { memberColumns, teacherColumns } from '@/config/tables/user/ArtPracticeWorksheet'
...
/* ---- 花名册 列定义 ---- */
/* Column 类型已在 @/config/tables/user/ArtPracticeWorksheet 中导出并使用，此处声明可删除 */
  ...
  <div class="scroll-container">
    <div class="voice-form">
      ...
      <el-card shadow="never" class="section-card sec-1">
        <template #header
          ><div class="card-title"><span>项目基础信息</span></div></template
        >
          ...
          <el-row :gutter="24">
            <el-col :span="8">
              <el-form-item label="项目名称" required>
                <el-input
                  v-model="baseForm.artworkName"
                  placeholder="请填写工作坊名称，不需要加书名号"
                />
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-row :gutter="24">
              ...
              <el-col :span="12">
                <el-form-item label="联系人单位" required>
                  <el-input
                    v-model="baseForm.contactUnit"
                    placeholder="填写联系人单位，例如：学校、组织等"
                  />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row :gutter="24">
              <el-col :span="12">
                <el-form-item label="联系人职务" required>
                  <el-input
                    v-model="baseForm.contactPosition"
                    placeholder="填写联系人职务，例如：负责人、负责人助理等"
                  />
                </el-form-item>
              </el-col>
              <el-col :span="12">
      ...
      <el-card shadow="never" class="section-card sec-3">
        ...
        <el-form-item prop="intro" required label="工作坊项目简介" label-width="190px">
          <el-input
            v-model="baseForm.intro"
            type="textarea"
            :rows="7"
            maxlength="500"
            show-word-limit
            placeholder="请填写工作坊文本介绍区"
            :disabled="readonly"
          />
        </el-form-item>
        ...
        <div style="color: red; font-size: 18px; margin-bottom: 10px; font-weight: 500">
          注：若选择是，请将设计方案设计图稿报送至工作坊组委会邮箱（expo@artsyexpo.cn）
        </div>
      </el-card>
      <!-- 2 上传作品 -->
...
@use '@/assets/styles/user_styles/ArtPracticeWorksheet.scss';
</style>
