...
const performerLimit = computed(() => {
  ...
  return {
    maxCount: 8,
    description: '作品文体不限，须使用普通话，人数不超过8人（含伴奏，学生不进行道具设置，不得伴舞），演出时间不超过5分钟'
  }
})
...
<template>
  <div class="scroll-container">
    ...
    <el-card shadow="never" class="intro-card">
     ...
     作品文体不限，须使用普通话，人数不超过 8 人（含伴奏，学生不进行道具设置，不得伴舞），演出时间不超过 5 分钟，需提交朗诵文稿的电子版。
      </div>
    </el-card>
...
<el-card shadow="never" class="section-card sec-4">
      ...
      <RosterBlock class="mt16" title="学生伴奏" :columns="accompColumns" v-model:rows="accomp" :readonly="readonly" />
