...
import {
  baseFormDefaults,
  categoryOptions as categoryOptionsConfig,
} from '@/config/forms/user/OAAERandIFPandSecondarySchools'
...
const categoryOptions = ref<CategoryOption[]>(categoryOptionsConfig)

// 监听级联选择器变化，更新performanceType
watch(
  () => baseForm.categoryPath,
  (newPath) => {
  ...
  <div class="scroll-container">
    <div class="voice-form">
      ...
      <el-card shadow="never" class="section-card sec-1">
        <template #header
          ><div class="card-title"><span>优秀成果基础信息</span></div></template
        >
...
@use '@/assets/styles/user_styles/OAAERandIFPandSecondarySchools.scss';
</style>
