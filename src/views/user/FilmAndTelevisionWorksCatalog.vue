...
<template>
  <div class="scroll-container">
    ...
    <el-card shadow="never" class="intro-card">
      ...
      优艺术作品需为原创，并提交创作说明（包括作品主题和创作过程）。<br>单张照和组照（每组不超过 4 幅，需标明顺序号）尺寸均为 14 英寸（30.48cm×35.56cm）；除影调处理外，不得利用电脑和暗房技术改变影像原貌。作者限 1 人。
      视频采用 MP4 或 MPG2 格式（压缩带宽不低于 10M，分辨率 1920×1080），视频内容不得使用网络素材，时长 3—10 分钟，文件大小不超过 1G。作者不超过 8 人。
      </div>
    </el-card>
          ...
          <el-col :span="8">
            <el-form-item label="作品形式" required>
              <el-select v-model="baseForm.performanceType" placeholder="请选择" style="width: 100%">
                <el-option label="单张照" value="singlePhoto" />
                <el-option label="组照" value="groupPhoto" />
